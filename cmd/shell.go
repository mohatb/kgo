...
var shellCmd = &cobra.Command{
	Use:   "shell",
	Short: "Access windows or linux nodes shell",
	Long: `
Access windows or Linux nodes shell.

It works by creating a privileged pod inside the node you specified,
The pod then uses nsenter to gain access to the container process and starts a shell`,
